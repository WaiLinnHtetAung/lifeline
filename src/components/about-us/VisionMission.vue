    ...
    <div class="vision-mission">
        ...
        <div class="vision">
            ...
            <div class="vision-content">
                <h2>Vision</h2>
                <p>To be the best Healthcare Service Provider in Myanmar</p>
            </div>
        </div>
        ...
        <div class="mission">
            ...
            <div class="vision-content">
                <h2>Mission</h2>
                <p>To Provide Quality Products with Reasonable Price & Reliable Service</p>
            </div>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .heading-container .first-line, .second-line {
        width: 250px;
        height: 2px;
        background: var(--sec-color);
    }
    ...
    .vision .vision-content h2, .mission h2 {
        color: #333;
    }
